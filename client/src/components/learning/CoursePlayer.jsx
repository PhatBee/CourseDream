...
const CoursePlayer = ({
    ...
    return (
         ...
         */
        <div className="learning-page-root flex flex-col bg-[#1c1d1f]" style={{ height: '100dvh' }}>
            ...
            <header className="flex-shrink-0 h-14 bg-[#1c1d1f] border-b border-[#3e4143] flex items-center justify-between px-4 z-30">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <div className="flex items-center gap-1 sm:hidden">
                        <button onClick={onPrev} className="p-1.5 rounded text-gray-400 hover:text-white hover:bg-white/10 transition-colors">
                            <ChevronLeft size={18} />
                        </button>
                        <button onClick={onNext} className="p-1.5 rounded text-gray-400 hover:text-white hover:bg-white/10 transition-colors">
