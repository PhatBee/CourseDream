                ...
                <div className="p-6 overflow-y-auto space-y-5 flex-1">
                                ...
                                <div className={`flex items-center gap-3 p-3 rounded-xl mb-3 ${isVideoLinked ? 'bg-green-50 border border-green-200' : 'bg-blue-50 border border-blue-200'}`}>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-700">
                                            {isVideoLinked ? '✅ Video đã upload lên AWS CloudFront' : '🔗 Video từ URL ngoài'}
                                        </p>
                    ...
                    <div className="flex gap-5">
                        <div className="flex-1">
                            <label className="block text-sm font-semibold mb-1.5 text-gray-700">⏱ Thời lượng</label>
                    ...
                    <div className="border-t pt-5">
                        <label className="block text-sm font-semibold mb-3 text-gray-700">📎 Tài liệu đính kèm</label>
