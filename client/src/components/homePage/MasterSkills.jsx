...
const MasterSkills = () => {
  const skills = [
    { id: 1, text: "Stay motivated with engaging instructors", icon: <Video className="w-6 h-6" /> },
    { id: 2, text: "Keep up with in the latest in cloud", icon: <Cloud className="w-6 h-6" /> },
    { id: 3, text: "Get certified with 100+ certification courses", icon: <Award className="w-6 h-6" /> },
    { id: 4, text: "Build skills your way, from labs to courses", icon: <Layout className="w-6 h-6" /> },
  ];
