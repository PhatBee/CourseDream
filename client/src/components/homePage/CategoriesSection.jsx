    ...
    <section className="py-20 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-left mb-10">
          <span className="text-rose-500 font-bold text-sm uppercase tracking-wider">Danh mục</span>
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mt-2">Top Danh mục</h2>
        </div>
          ...
          {displayCategories.map((cat) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{cat.courseCount || 0} Khóa học</p>
              </div>
            </Link>
          ))}
        </div>
