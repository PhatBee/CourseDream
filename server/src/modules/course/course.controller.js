...
export const getPendingCourses = async (req, res, next) => {
  try {
    const result = await courseService.getPendingRevisions(req.query);
...
export const getPendingCourseDetail = async (req, res, next) => {
  try {
    ...
    const data = await courseService.getPendingRevisionDetail(revisionId);
...
export const approveCourseRevision = async (req, res, next) => {
  try {
    ...
    const result = await courseService.approveRevision(revisionId, adminId);
